function [sob_vsla, sof_vsla, kgd]=A_BRFv2_single_hemi(tts,CIs,CIy1,CIy2,LAI,lidf)
...
for i=1:8
    ...
    for j=1:8
        ...
        [Gs,Ga,k,Ka,sob,sof]    =   PROSAIL(tts,tta,psia,lidf);      
        
        [CIa]=CIxy(CIy1,CIy2,tta);
        
        [kca, kga]    =   sunshade(tts,tta,psia,Gs,Ga,CIs,CIa,LAI);     
